...
cart1.map(function({image1,title,price,discount}){
...
// let cart = document.getElementById("cart11")
...
function openNav() {
  document.getElementById("cart11").style.width = "250px";
